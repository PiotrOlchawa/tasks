...
public class TrelloFacadeTest {
    ...
    public void createCard() {
        //Given
        TrelloCardDto trelloCardDto = new TrelloCardDto("card", "card","top", "id");

        CreatedTrelloCardDto createdCardDto = new CreatedTrelloCardDto("1", "card", "https://test.com");

        TrelloCard trelloCard = new TrelloCard("card", "card", "top", "id1");
